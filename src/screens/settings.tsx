  ...
  return (
    <div className="p-6 max-w-[1280px] mx-auto anim-fade-up">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <Card className="p-6">
          <h2 className="text-[16px] font-bold text-ink mb-4">{t("settings.doctor_profile")}</h2>
          ...
          <div className="space-y-4">
            <Field label={t("field.full_name")} value={form.name} onChange={(v) => setForm({ ...form, name: v })} />
            <Field label={t("field.specialization")} value={form.specialization} onChange={(v) => setForm({ ...form, specialization: v })} />
            ...
            <Field label={t("field.str")} value={form.str} onChange={(v) => setForm({ ...form, str: v })} />
            <Field label={t("field.facility")} value={form.facility} onChange={(v) => setForm({ ...form, facility: v })} />
            <Field label={t("field.phone")} value={form.phone} onChange={(v) => setForm({ ...form, phone: v })} />
          </div>
        </Card>
        <div className="space-y-6">
          <Card className="p-6">
            <h2 className="text-[16px] font-bold text-ink mb-4">{t("settings.preferences")}</h2>
            <p className="text-[13px] font-semibold text-muted mb-2">{t("settings.theme")}</p>
            ...
            <p className="text-[13px] font-semibold text-muted mb-2 mt-5">{t("settings.language")}</p>
          ...
          <Card className="p-6">
            <h2 className="text-[16px] font-bold text-ink mb-4">{t("settings.notifications")}</h2>
          ...
          <Card className="p-6">
            <h2 className="text-[16px] font-bold text-ink mb-4">{t("settings.account")}</h2>
